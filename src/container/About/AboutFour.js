                        ...
                        <div className=" col-xl-6 col-lg-6 col-12">
                            <div className="video-popup-area">
                                <div className="skill-video">
                                    ...
                                    <p style={{ color: '#525252', fontFamily: 'Inter' }}>Gigahertz Computing&apos;s story began in Bangalore in 1999, a fresh start under proprietorship. They dove headfirst into the world of computers and peripherals, offering sales and services. The IT revolution was in full swing, and Gigahertz quickly established itself as a leader in computer hardware and services, leveraging their deep knowledge and expertise to build a large and loyal customer base. Their reach expanded to include public sectors, government organizations, multinational corporations, and educational institutions.</p>
